...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@ddk/host-sdk": async () => {
          let pkg = await import("__mf__virtual/sla_plugin__prebuild___mf_0_ddk_mf_1_host_mf_2_sdk__prebuild__.js");
            return pkg;
        }
      ,
        "@fluentui/react-components": async () => {
          let pkg = await import("__mf__virtual/sla_plugin__prebuild___mf_0_fluentui_mf_1_react_mf_2_components__prebuild__.js");
            return pkg;
        }
      ,
        "@fluentui/react-icons": async () => {
          let pkg = await import("__mf__virtual/sla_plugin__prebuild___mf_0_fluentui_mf_1_react_mf_2_icons__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
          let pkg = await import("__mf__virtual/sla_plugin__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/sla_plugin__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
